...
Tenho interesse em tecnologia e desenvolvimento de software, principalmente na criação de aplicações **modernas, funcionais e bem estruturadas**. Atualmente, venho aprimorando meus conhecimentos no desenvolvimento web utilizando **React, JavaScript, TypeScript, Node.js, HTML5, CSS3 e Tailwind CSS**.
...
No momento, meu foco está em evoluir cada vez mais como desenvolvedor, aprofundando meus conhecimentos em **Front-End e Back-End**, além de explorar novas áreas do desenvolvimento. Tenho também interesse em aprender **React Native** para expandir meus conhecimentos para o desenvolvimento de aplicações mobile.

🚀 **Meu objetivo é continuar aprendendo, construir projetos cada vez melhores e evoluir constantemente como profissional da área de tecnologia.**
